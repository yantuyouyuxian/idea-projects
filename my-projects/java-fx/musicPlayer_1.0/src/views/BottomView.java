...
public class BottomView {
	...
	public void initial() {
		...
		files=MusicFileFromMySQL.getMusicFiles();
		
		medias=MusicFileFromMySQL.getMusicMedias();
		...
		Image set_w=new Image("icon_white/set.png");
		Image set_b=new Image("icon_black/set.png");
		
		ArrayList<Image> cycle=new ArrayList<>();
		cycle.add(new Image("icon_white/repeat.png"));//0是全部
		cycle.add(new Image("icon_white/repeatone.png"));//1是单曲
		cycle.add(new Image("icon_white/random.png"));//2是随机
		cycle.add(new Image("icon_black/repeat.png"));//0是全部
		cycle.add(new Image("icon_black/repeatone.png"));//1是单曲
		cycle.add(new Image("icon_black/random.png"));//2是随机
		
		Image last_w=new Image("icon_white/last.png");
		Image last_b=new Image("icon_black/last.png");
		Image play_w=new Image("icon_white/play.png");
		Image play_b=new Image("icon_black/play.png");
		Image pause_w=new Image("icon_white/pause.png");
		Image pause_b=new Image("icon_black/pause.png");
		Image next_w=new Image("icon_white/next.png");
		Image next_b=new Image("icon_black/next.png");
		Image list_w=new Image("icon_white/list.png");
		Image list_b=new Image("icon_black/list.png");
		Image vol_w=new Image("icon_white/vol.png");
		Image vol_b=new Image("icon_black/vol.png");
		Image mute_w=new Image("icon_white/mute.png");
		Image mute_b=new Image("icon_black/mute.png");
		...
		isplaying.addListener(new ChangeListener<Boolean>() {
			...
			public void changed(ObservableValue<? extends Boolean> observable, Boolean oldValue, Boolean newValue) {
				// TODO Auto-generated method stub
				System.out.println("isplaying:  "+newValue);
	...
	public void myPlay(){
		...
		mp.currentTimeProperty().addListener(new ChangeListener<Duration>() {
			...
			public void changed(ObservableValue<? extends Duration> observable, Duration oldValue, Duration newValue) {
				// TODO Auto-generated method stub
				System.out.println("currentTimeProperty: "+newValue);
				...
				System.out.println("now:"+mp.getCurrentTime().toSeconds()+"  total:"+mp.getTotalDuration().toSeconds());
			}
		});
