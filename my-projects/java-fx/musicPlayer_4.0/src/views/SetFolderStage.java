...
public class SetFolderStage {
	...
	public void initial(){
		...
		//关闭图标----------------------------------------------------------------------
		Image close_w=new Image(str+"icon_white/close.png");
		Image close_b=new Image(str+"icon_black/close.png");
		...
		//添加目录-------------------------------------------------------------
		Image add_w=new Image(str+"icon_white/add.png");
		Image add_b=new Image(str+"icon_black/add.png");
		...
		// 背景图片
		ImageView bg = new ImageView(str+"bgimg/bg2.jpg");
		bg.setSmooth(true);
		bg.setClip(bgclip);
