...
public class TopView extends HBox{
	...
	public  void initial() {
		...
		Image close = new Image(str+"icon_white/close.png");
		Image full = new Image(str+"icon_white/full.png");
		Image min = new Image(str+"icon_white/min.png");
		Image normal = new Image(str+"icon_white/normal.png");
		...
		image=Toolkit.getDefaultToolkit().getImage(System.getProperty("user.dir")+"/java-fx/musicPlayer_4.0/icon_tray/trayicon.png");
