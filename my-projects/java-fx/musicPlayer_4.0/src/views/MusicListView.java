...
//	private double height=500;
	...
	public void initial(){
		...
		listview=new ListView<File>(MusicFileFromPath.getMusicFiles());
			...
			public ListCell<File> call(ListView<File> param) {
				...
				mi1.setOnAction(new EventHandler<ActionEvent>() {
					...
					public void handle(ActionEvent event) {
						...
						MusicFileFromPath.getMusicFiles().remove(cell.getIndex());
						
						MusicFileFromPath.getMusicMedias().remove(cell.getIndex());
...
//		listview.setPrefHeight(height);
		listview.prefHeightProperty().bind(anpane.prefHeightProperty());
		
		listview.setPrefWidth(width);
		
		anpane.setTranslateX(xtran);
		
//		anpane.setBorder(new Border(new BorderStroke(Color.WHITE, BorderStrokeStyle.SOLID, null, new BorderWidths(2))));
