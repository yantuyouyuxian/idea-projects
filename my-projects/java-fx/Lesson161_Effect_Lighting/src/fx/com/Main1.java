...
public class Main1 extends Application{
	...
	public Effect getEffect() {
		...
		light.setSurfaceScale(10);
		light.setDiffuseConstant(2);
		light.setSpecularConstant(2);
		light.setSpecularExponent(40);
		
		Light.Distant dis=new Light.Distant();
		dis.setColor(Color.YELLOW);
//		dis.setAzimuth(90);//角度
//		dis.setElevation(value);
		light.setLight(dis);
		
		light.setBumpInput(new GaussianBlur());//设置突起部分效果
		
//		light.setContentInput(value);
