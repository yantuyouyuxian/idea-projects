...
public class Main2 extends Application{
	...
	public void start(Stage primaryStage) throws Exception {
		...
		for(int i=0; i<5; i++) {
			Cylinder cylinder=new Cylinder(50,150,128);
			list.add(cylinder);
		}
		
		Cylinder b1=(Cylinder)hbox.getChildren().get(0);
...
//		System.out.println(b1.getRotationAxis());
		...
		Cylinder b2=(Cylinder)hbox.getChildren().get(1);
		...
		Cylinder b3=(Cylinder)hbox.getChildren().get(2);
