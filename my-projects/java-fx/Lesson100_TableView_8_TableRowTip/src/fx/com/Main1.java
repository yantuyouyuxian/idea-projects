				...
				TableCell<Data2, String> cell=new TableCell<Data2, String>() {
					...
					protected void updateItem(String item, boolean empty) {
						...
						if(empty == false && item != null) {
							...
							this.setTooltip(new Tooltip(this.getIndex()+"  "+item));
...
//
//					TableCell<Data2, Number> tablecell=this;
//					
//					@Override
...
//						Label label=new Label(String.valueOf(data.getAge()));
//						hbox.getChildren().add(label);
//						this.setGraphic(hbox);
//					}
//
...
//						// hbox.setStyle("-fx-background-color:yellow");
//						hbox.setAlignment(Pos.CENTER);
//						TextField tf=new TextField(this.getUserData().toString());
//						
...
//								// TODO Auto-generated method stub
//								Data2 data=(Data2)tablecell.getTableRow().getItem();
////								data.setAge(Integer.valueOf(tf.getText()));
//								tablecell.commitEdit(Integer.valueOf(tf.getText()));
//							}
//						});
//					}
//
...
//							// hbox.setStyle("-fx-background-color:yellow");
//							hbox.setAlignment(Pos.CENTER);
//							Label label=new Label(String.valueOf(item.intValue()));
//							hbox.getChildren().add(label);
//							this.setGraphic(hbox);
//						}
//					}
...
//								this.setStyle(null);
//							}
//							this.setBorder(new Border(new BorderStroke(Paint.valueOf("red"), BorderStrokeStyle.DOTTED, new CornerRadii(5), new BorderWidths(2))));
//							
